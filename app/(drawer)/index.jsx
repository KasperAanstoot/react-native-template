      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Card style={styles.card}>
          ...
          <Card.Content>
            ...
            <Text variant="bodyMedium" style={styles.paragraph}>
              Add new screens by creating files inside{' '}
              <Text style={{ fontWeight: 'bold', color: theme.colors.primary }}>app/(drawer)</Text>{' '}
              or by composing nested layouts with Expo Router.
            </Text>
          </Card.Content>
        </Card>
      </ScrollView>
